...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagsToAttribute.Add(GameplayTags.Attributes_Secondary_CritResist, GetCritResistAttribute);
...
void UAuraAttributeSet::SetEffectProperties(const FGameplayEffectModCallbackData& Data, FEffectProperties& Props) const
{
	...
	/**
	 * Source = causer of the effect, Target = target of the effect (owner of this AbilitySystem)
	 * For both source and target we try to save:
	 *	- AbilirySystemComponent(ASC)
	 *	- AvatarActor
	 *	- Controller
	 *	- Character
	 */
	...
	if (IsValid(Props.SourceASC) && Props.SourceASC->AbilityActorInfo.IsValid() && Props.SourceASC->AbilityActorInfo->AvatarActor.IsValid())
	{
		...
		// Get player controller if able, otherwise get pawn controller if able
